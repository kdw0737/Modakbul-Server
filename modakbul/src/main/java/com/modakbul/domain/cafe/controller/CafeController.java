...
public class CafeController {
	...
	public BaseResponse<List<CafeResDto.CafeListDto>> getCafeListSortByDistance(
	...
	public BaseResponse<List<CafeResDto.CafeListDto>> getCafeListSortByMeetingCount(
		@RequestParam(value = "latitude") double latitude, @RequestParam(value = "longitude") double longitude) {
	...
	@GetMapping("/cafes")
	public BaseResponse<List<CafeResDto.CafeListDto>> searchCafeList(
